...
<table width="100%">
	...
	<tr>
		<td><html:form action="/adminBookSearch">
			<table align="center">
				<tr>
					<td>Title:&nbsp;&nbsp;&nbsp; <html:text
						property="frmBookTitle" styleId="frmBookTitle" />
					<div class="choices" id="choices1"></div>
					</td>
				</tr>
				<tr>
					<td>Author: <html:text property="frmAuthorName"
				...
				<tr>
					<td colspan="2"><html:submit property="btnSearch"
						value="Search"></html:submit></td>
				</tr>
				<tr>
					<td><font size="3"> <html:errors property="searchError" />
					</font></td>
		...
		<table align="center" border="1">
			...
			<c:forEach var="i" begin="${AutoFormBean.begin}"
				end="${AutoFormBean.end}" step="1">
				<tr>
					...
					<td><a
						href="adminSearchDetailPath.do?frmDetailBookId=${AutoFormBean.frmBookList[i-1].id}&frmControl=1">Detail
					</a></td>
		...
		<table align="center">
			<tr>
				<td>
				<div align="center"><c:if test="${AutoFormBean.prevBtn}">&lt;&lt;
                      <html:submit property="prev" value="Previous">
					</html:submit>
				</c:if></div>
				</td>
				<td>
				<div align="center"><c:if test="${AutoFormBean.nextBtn}">
