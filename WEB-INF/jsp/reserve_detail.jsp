...
<p align="center">
	...
	<table align="center">
	<tr>
		<td><html:img src="${LoginFormBean.frmViewPhoto}" height="100" width="100"/></td>
	</tr>
	<tr>
		<td>Title</td>
	...
	<tr>
		<td colspan="2" align="center">
			<html:submit property="btnReserve" value="Reserve"></html:submit>
		</td>
	</tr>
	<tr>
	<html:errors property="reserveError" /> 
	<html:errors property="reserveError1" /> 
	<html:errors property="reserveError2" />
	</tr>
	</table>
</html:form>	
