...
<html:form action="/checkinPathFirst">
	<table align="center">
		<tr>
			<td>Call Number</td>
			<td><html:text property="frmCallNumber"></html:text><font
				color="red">***</font></td>
			<td><html:errors property="frmCallNumber" /> <html:errors
				property="checkinbookserror" /><html:errors
				property="checkinerror" />
				<html:errors property="checkinerror2" />
				</td>
