...
<html:form action="/bookupdatePathFirst">
	<table align="center">
		...
		<tr>
			<td>No Of Copies</td>
			<td><html:text property="noOfcopies"></html:text><font
				color="red">***</font></td>
			<td><html:errors property="noOfcopies" /></td>
		</tr>

		<tr>
			<td><html:submit property="btnUpdate" value="Add">
			</html:submit></td>
			<td><html:submit property="btnUpdateCancel" value="Cancel">
			</html:submit></td>
			<td align="center"><font color="red"> <html:errors
				property="copyadd" />
				<html:errors
				property="copynegative" />
				</font></td>
		</tr>
