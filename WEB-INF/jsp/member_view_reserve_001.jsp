...
<br>
<div class="table">
<p align="center"><font size=+1 color="black">Member View
Reserve Form</font></p>
<br>

<html:form action="/viewReservePath">
		...
		<table border="1" width="100%" cellspacing=0 cellpadding=7>
			...
			<c:forEach var="i" begin="${ViewReserveFormBean.begin}"
				...
				<tr>
					...
					<td><c:if
						test="${ViewReserveFormBean.frmViewBookReserveList[i-1].reserveStatus==0}">Canceled</c:if>
					<c:if
