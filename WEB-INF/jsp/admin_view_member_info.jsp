...
<html:form action="/adminViewMemberInfoPath">
	...
	<logic:notEmpty name="AdminViewMemberFormBean"
		...
		<table border="1" width="100%" height="auto" cellspacing=0
			...
			<c:forEach var="i" begin="${AdminViewMemberFormBean.begin}"
				...
				<tr align="center">
					...
					<td><c:if
						test="${AdminViewMemberFormBean.frmViewMemberList[i-1].userStatus==1}">
						<html:multibox property="selectedItem"
							value="${AdminViewMemberFormBean.frmViewMemberList[i-1].id} ${AdminViewMemberFormBean.frmViewMemberList[i-1].userEmail} ${AdminViewMemberFormBean.frmViewMemberList[i-1].expireDate}"
							name="AdminViewMemberFormBean">
						</html:multibox>
					</c:if></td>
		...
		<table align="right">
			<tr align="center">
				<td><html:submit property="btnDelete" value="Delete"></html:submit>
				</td>
			</tr>
		</table>
		<table align="center">
